...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT courseCode, courseDesc, Count(student_id) AS numStudents FROM course JOIN course_student ON course.cid = course_student.course_id GROUP BY cid";
